            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <div class="row">
                            <div class="col-6 form-group">
                                <input type="text" name="a1" class="form-control p-4" placeholder="First Name" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input type="text" name="a2" class="form-control p-4" placeholder="Last Name" required="required">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6 form-group">
                                <input type="email" name="a3" class="form-control p-4" placeholder="Your Email" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input type="text" name="a4" class="form-control p-4" placeholder="Mobile Number" required="required">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        <div class="row">
                            <div class="col-6 form-group">
                                <select class="custom-select px-4" style="height: 50px;" name="a5">
                            ...
                            <div class="col-6 form-group">
                                <input type="hidden" name="a6" class="form-control p-4" value="<?php echo $res['name']; ?>">
                            </div>
                            <div class="col-6 form-group">
                                <input type="hidden" name="a11" class="form-control p-4" value="<?php echo $username; ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6 form-group">
                                <div class="date" id="date2" data-target-input="nearest">
                                    <input type="text" name="a7" class="form-control p-4 datetimepicker-input" placeholder="Pickup Date"
                                        data-target="#date2" data-toggle="datetimepicker" />
                                </div>
                            </div>
                            <div class="col-6 form-group">
                                <input name="a9" type="text" class="form-control p-4" placeholder="Adhar Card Number" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input name="a10" type="text" class="form-control p-4" placeholder="Address" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input name="a12" type="hidden" class="form-control p-4" value="On The Way"required="required">
                            </div>
                        </div>
                        <input class="btn btn-block btn-primary py-3" type="submit" value="Book Now">
                    </div>
                    </form>
                </div>
            </div>
