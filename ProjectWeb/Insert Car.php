...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="Insert Car.php?id=<?php echo $id; ?>" class="nav-item nav-link active">Insert Cars</a>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Insert Cars</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="AdminHome.php?id=<?php echo $id; ?>">AdminHome</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Insert Cars</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Insert Car's Detail</h1>
            <div class="row">
                        ...
                        <form action="imgcode.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input name="a1" type="text" class="form-control p-4" placeholder="Enter Car's Name" required="required">
                                </div>
                                <div class="col-6 form-group">
                                    <input name="a2" type="text" class="form-control p-4" placeholder="Enter Car's Price" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                                <input name="a3" type="text" class="form-control p-4" placeholder="Enter Car's CC" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a4" type="text" class="form-control p-4" placeholder="Enter Car's Type" required="required">
                            </div>
                            <div class="form-group">
                                <span>Enter Car's Image: </span>
                                <input name="a5" type="file" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a6" type="text" class="form-control p-4" placeholder="Enter Mileage" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a7" type="text" class="form-control p-4" placeholder="Enter Fuel Type" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a8" type="text" class="form-control p-4" placeholder="Enter Transmission Type" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a9" type="text" class="form-control p-4" placeholder="Enter Car's BHP" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a10" type="text" class="form-control p-4" placeholder="Enter Car's Seating Capacity" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a11" type="text" class="form-control p-4" placeholder="Enter Car's Torque" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a12" type="text" class="form-control p-4" placeholder="Enter Car's Gearbox Speed" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a13" type="text" class="form-control p-4" placeholder="Enter Car's Top Speed" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a14" type="text" class="form-control p-4" placeholder="Enter Car's Fuel Tank Capacity" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a15" type="text" class="form-control p-4" placeholder="Enter Car's Dimensions" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a16" type="text" class="form-control p-4" placeholder="Enter Car's Brand" required="required">
                            </div>
                            <div class="form-group">
                                <textarea name="a17" class="form-control py-3 px-4" rows="5" placeholder="Enter Car's Details" required="required"></textarea>
                            </div>
                            <div class="col-6 form-group">
                                <input type="hidden" name="a18" class="form-control p-4" value="<?php echo $id; ?>">
                            </div>
                            <div>
