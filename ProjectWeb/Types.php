...
$sql = "select * from cars where type='$types'";
?>
...
<body>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Car Types</a>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Car List</h1>
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                    ...
                    <div class="rent-item mb-4">
                        <a href="Details.php?id=<?php echo $res['id']; ?>&username=<?php echo $username; ?>"><img class="img-fluid mb-4" src="<?php echo $res['image']; ?>" height="250px" width="500px" alt=""></a>
                        ...
                        <div class="px-2">
                            ...
                            <div class="px-2 border-left border-right">
                                ...
                                <span>Transmission Of the Car: <?php echo("&nbsp;"); echo $res['transmission']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Type Of the Car: <?php echo("&nbsp;"); echo $res['type']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Bhp Of the Car: <?php echo("&nbsp;"); echo $res['bhp']; ?></span>
                            </div>
                            <div class="px-2">
                                <i class="fa fa-road text-primary mr-1"></i>
                                <span>Price Of The Car:<?php echo("&nbsp;"); echo $res['price']; ?></span>
                            </div>
                        </div>
