...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="About.php?username=<?php echo $username; ?>" class="nav-item nav-link active">About</a>
    ...
    <!-- About End -->
     ...
     <!-- Founder / Co-Founder Start -->
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Our Founders and Co-Founders</h1>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="photos/Rajdeep.jpeg" height="200px" alt="">
                        <h4 class="text-uppercase mb-4">Rajdeep Datta (Founder)</h4>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="photos/Soum2.jpg" height="100px" alt="">
                        <h4 class="text-uppercase mb-4">Soumyaraj Datta (Co-Founder)</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="https://www.facebook.com/profile.php?id=100017766373604&mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
                            </div>
                            <div class="px-2 border-left border-right">
                                <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="https://twitter.com/soumyaraj_82374?t=r_Q5J_jIRVZ2yZC-zoh-hA&s=08"><i class="fab fa-twitter"></i></a>
                            </div>
                            <div class="px-2">
                                <a class="btn btn-lg btn-dark btn-lg-square" href="https://instagram.com/s_o_u_m_y_a_r_a_j?igshid=MzNlNGNkZWQ4Mg=="><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="photos/Raksha.jpg" alt="">
                        <h4 class="text-uppercase mb-4">Raksha Raj (Co-Founder)</h4>
                        <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                                <a class="btn btn-lg btn-dark btn-lg-square" href="https://instagram.com/_.p.r.i.n.c.y._27?igshid=MzNlNGNkZWQ4Mg=="><i class="fab fa-instagram"></i></a>
                        </div>
                        <div class="px-2">
                                <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="https://www.linkedin.com/in/princy-roy-7b6667228"><i class="fab fa-linkedin-in"></i></a>
                            </div>
                            <!-- <div class="px-2 border-left border-right">
                                <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="https://twitter.com/soumyaraj_82374?t=r_Q5J_jIRVZ2yZC-zoh-hA&s=08"><i class="fab fa-twitter"></i></a>
                            </div> -->
