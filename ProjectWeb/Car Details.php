...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-1 text-primary text-center">Find Your Dream Cars</h1>
            <h1 class="display-4 text-uppercase text-center mb-5">Type: <?php echo $types; ?></h1>
            ...
            <div class="row">
                    ...
                    <div class="rent-item mb-4">
                        <a href="detailsAdmin.php?idd=<?php echo $res['id']; ?>&id=<?php echo $id; ?>"><img class="img-fluid mb-4" src="<?php echo $res['image']; ?>" height="250px" width="500px" alt=""></a>
                        <h4 class="text-uppercase mb-4"><?php echo $res['name']; ?></h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Car's Price: <?php echo("&nbsp;"); echo $res['price']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's CC: <?php echo("&nbsp;"); echo $res['cc']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Type: <?php echo("&nbsp;"); echo $res['type']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Mileage: <?php echo("&nbsp;"); echo $res['mileage']; ?></span>
                            </div>
                            <div class="px-2">
                                <i class="fa fa-road text-primary mr-1"></i>
                                <span>Car's Fuel Type:<?php echo("&nbsp;"); echo $res['fuel']; ?></span>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Car's Transmission: <?php echo("&nbsp;"); echo $res['transmission']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Bhp: <?php echo("&nbsp;"); echo $res['bhp']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Seating Capacity: <?php echo("&nbsp;"); echo $res['seat']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Torque: <?php echo("&nbsp;"); echo $res['torque']; ?></span>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                                <i class="fa fa-road text-primary mr-1"></i>
                                <span>Car's Gearbox:<?php echo("&nbsp;"); echo $res['gearbox']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Car's Topspeed: <?php echo("&nbsp;"); echo $res['topspeed']; ?></span>
                            </div>
                            <div class="px-2 border-left border-right">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Fuel Capacity: <?php echo("&nbsp;"); echo $res['fuelcapacity']; ?></span>
                            </div>
                            <div class="px-2">
                                <i class="fa fa-cogs text-primary mr-1"></i>
                                <span>Car's Dimensions: <?php echo("&nbsp;"); echo $res['dimension']; ?></span>
                            </div>
                        </div>
                        <a class="btn btn-primary px-3" href="Edit Details.php?id=<?php echo $id; ?>&car=<?php echo $res['id']; ?>">Edit Details</a>
                    </div>
                    <?php
                    }
                    ?>
