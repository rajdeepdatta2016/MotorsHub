            ...
            <div class="row">
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="Edcode.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <span><h5>Name of Car:</h5></span>
                                <input name="a1" type="text" class="form-control p-4" value="<?php echo $res['name']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Price of Car:</h5></span>
                                <input name="a2" type="text" class="form-control p-4" value="<?php echo $res['price']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>CC of Car:</h5></span>
                                <input name="a3" type="text" class="form-control p-4" value="<?php echo $res['cc']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Car's Type:</h5></span>
                                <input name="a4" type="text" class="form-control p-4" value="<?php echo $res['type']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Mileage of Car:</h5></span>
                                <input name="a5" type="text" class="form-control p-4" value="<?php echo $res['milease']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Fuel Type of Car:</h5></span>
                                <input name="a6" type="text" class="form-control p-4" value="<?php echo $res['fuel']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Transmission of Car:</h5></span>
                                <input name="a7" type="text" class="form-control p-4" value="<?php echo $res['transmission']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Bhp of Car:</h5></span>
                                <input name="a8" type="text" class="form-control p-4" value="<?php echo $res['bhp']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Seating Capacity of Car:</h5></span>
                                <input name="a9" type="text" class="form-control p-4" value="<?php echo $res['seat']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Torque of Car:</h5></span>
                                <input name="a10" type="text" class="form-control p-4" value="<?php echo $res['torque']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Gearbox of Car:</h5></span>
                                <input name="a11" type="text" class="form-control p-4" value="<?php echo $res['gearbox']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Top Speed of Car:</h5></span>
                                <input name="a12" type="text" class="form-control p-4" value="<?php echo $res['topspeed']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Fuel Capacity of Car:</h5></span>
                                <input name="a13" type="text" class="form-control p-4" value="<?php echo $res['fuelcapacity']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Dimensions of Car:</h5></span>
                                <input name="a14" type="text" class="form-control p-4" value="<?php echo $res['dimension']; ?>" required="required">
                            </div>
                            <div class="form-group">
                                <span><h5>Brand of Car:</h5></span>
                                <input name="a15" type="text" class="form-control p-4" value="<?php echo $res['brand']; ?>" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input type="hidden" name="a16" class="form-control p-4" value="<?php echo $id; ?>">
                            </div>
                            <div class="col-6 form-group">
                                <input type="hidden" name="a17" class="form-control p-4" value="<?php echo $car; ?>">
                            </div>
                            <div>
