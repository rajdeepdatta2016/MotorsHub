...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="Show Contact.php?id=<?php echo $id; ?>" class="nav-item nav-link active">Show Contact</a>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Contact Of Users</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="AdminHome.php?id=<?php echo $id; ?>">AdminHome</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Contact Of Users</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-1 text-primary text-center">Contact Us List</h1>
            ...
            <div class="row">
                    ...
                    <div class="rent-item mb-4">
                        <h4 class="text-uppercase mb-4">Name Of User: <?php echo("&nbsp;"); echo $res['name']; ?></h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2 border-right">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Subject Of The Message: <?php echo("&nbsp;"); ?></span>
                                <span><?php echo $res['subject']; ?></span>
                            </div>
                            <div class="px-2 border-right">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Message Of The User: <?php echo("&nbsp;"); ?></span>
                                <span><?php echo $res['msg']; ?></span>
                            </div>
                            <div class="px-2 border-right">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Username Of The User: <?php echo("&nbsp;"); ?></span>
                                <span><?php echo $res['username']; ?></span>
                            </div>
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>Delete The Contact: <?php echo("&nbsp;"); ?></span>
                                <a class="btn btn-primary px-3" href="DeleteContact.php?id=<?php echo $id; ?>&deleteid=<?php echo $res['id']; ?>">Delete</a> 
                            </div>
                        </div>
                    </div>
                    <?php
