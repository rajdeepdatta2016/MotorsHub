...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="Insert Admin.php?id=<?php echo $id; ?>" class="nav-item nav-link active">Insert Admin</a>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Insert Admins</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="AdminHome.php?id=<?php echo $id; ?>">AdminHome</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Insert Admins</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Insert Admins</h1>
            <div class="row">
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="admcode.php">
                            <div class="form-group">
                                <input name="a1" type="text" class="form-control p-4" placeholder="Enter Admin Id" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a2" type="text" class="form-control p-4" placeholder="Enter Name" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a3" type="text" class="form-control p-4" placeholder="Enter Password" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a4" type="text" class="form-control p-4" placeholder="Confirm Password" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a5" type="date" class="form-control p-4" placeholder="Enter Date Of Birth" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input type="hidden" name="a6" class="form-control p-4" value="<?php echo $id; ?>">
                            </div>
                            <div>
