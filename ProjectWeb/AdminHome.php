            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="AdminHome.php?id=<?php echo $id; ?>" class="nav-item nav-link active">Home</a>
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <p>This Website is made on 2023 at Kolkata under the <a href="https://www.ardentcollaborations.com/">ARDENT COMPUTECH PVT. LTD.</a> made by <b>Rajdeep Datta, Soumyaraj Datta and Raksha Raj</b>; Student of <a href="https://iutripura.edu.in/">ICFAI UNIVERSITY TRIPURA</a>.<br> <a href="Home.html">MOTORS HUB Tech's</a> mission is to provide the proper details of any cars with their delightful prices and a way where the Dealer and Buyer can connect with each other very easily.</p>
                </div>
            </div>
            <div class="row mt-3">
