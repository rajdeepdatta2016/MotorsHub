            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="Change Password.php?username=<?php echo $username; ?>" class="nav-item nav-link active">Change Password</a>
            ...
            <div class="row">
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="cngpwd.php" method="post">
                            <div class="form-group">
                                    <input name="a1" type="text" class="form-control p-4" placeholder="Change Password" required="required">
                            </div>
                            <div class="form-group">
                                <input name="a2" type="text" class="form-control p-4" placeholder="Confirm Password" required="required">
                            </div>
                            <div class="col-6 form-group">
                                <input type="hidden" name="a3" class="form-control p-4" value="<?php echo $username; ?>">
                            </div>
                            <div>
